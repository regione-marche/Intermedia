...
import it.extrasys.marche.regione.fatturapa.contracts.areas.ricezione.notifiche.fatturazione.attiva.beans.*;
 ...
 */
public class CreaRichiestaRegistraAttivaNotificheProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        String fileRicevutaConsegna = (String)msg.getBody();
        ...
        xmlType.setValue(fileRicevutaConsegna.getBytes());
