...
public class FatturaPaCanaleNonTrovatoExceptionHandler implements ExceptionMapper<FatturaPACanaleNonTrovatoException> {

    public Response toResponse(FatturaPACanaleNonTrovatoException exception) {
