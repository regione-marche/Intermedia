 ...
 */
public class InviaDecorrenzaTerminiDaDatabase {

    private static final Logger LOG = LoggerFactory.getLogger(InviaDecorrenzaTerminiDaDatabase.class);
    ...
    public void prelevaDecorrenzaTerminiDalDatabase(Exchange exchange) throws IOException, ParserConfigurationException, TransformerException, SAXException, XPathExpressionException {
        ...
        LOG.info("InviaDecorrenzaTerminiDaDatabase - prelevaFatturaDalDatabase: identificativoSdI = " + identificativoSdiString);
        ...
        if(identificativoSdiString != null && !"".equals(identificativoSdiString)) {
            ...
            LOG.error("InviaDecorrenzaTerminiDaDatabase - prelevaFatturaDalDatabase: identificativoSdI vuoto o NULL");
        }
    }
