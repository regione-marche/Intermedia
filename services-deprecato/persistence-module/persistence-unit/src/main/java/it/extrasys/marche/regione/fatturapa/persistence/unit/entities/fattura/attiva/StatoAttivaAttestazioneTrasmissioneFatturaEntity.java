...
@Entity
@Table(name = "STATO_ATTIVA_ATTESTAZIONE_TRASMISSIONE_FATTURA")
@IdClass(StatoAttivaAttestazioneTrasmissioneFatturaPK.class)
public class StatoAttivaAttestazioneTrasmissioneFatturaEntity implements IEntity {

    private static final long serialVersionUID = 1L;

    @Id
    @ManyToOne
    @JoinColumn(name = "ID_ATTESTAZIONE_TRASMISSIONE_FATTURA", nullable = false)
    private FatturaAttivaAttestazioneTrasmissioneFatturaEntity attestazioneTrasmissioneFatturaEntity;
    ...
    public StatoAttivaAttestazioneTrasmissioneFatturaEntity() {
        //needed from jpa
    }
    ...
    public FatturaAttivaAttestazioneTrasmissioneFatturaEntity getAttestazioneTrasmissioneFatturaEntity() {
        return attestazioneTrasmissioneFatturaEntity;
    }

    public void setAttestazioneTrasmissioneFatturaEntity(FatturaAttivaAttestazioneTrasmissioneFatturaEntity attestazioneTrasmissioneFatturaEntity) {
