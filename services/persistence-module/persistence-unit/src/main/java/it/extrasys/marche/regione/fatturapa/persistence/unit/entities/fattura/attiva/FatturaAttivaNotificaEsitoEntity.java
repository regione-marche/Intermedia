 ...
 */
@Entity
@Table(name = "FATTURA_ATTIVA_NOTIFICA_ESITO")
public class FatturaAttivaNotificaEsitoEntity implements IEntity {

    @Id
    @GeneratedValue(strategy= GenerationType.AUTO)
    @Column(name="ID_NOTIFICA_ESITO")
    private BigInteger idNotificaEsito;
    ...
    public FatturaAttivaNotificaEsitoEntity(){

    }

    public BigInteger getIdNotificaEsito() {
        return idNotificaEsito;
    }

    public void setIdNotificaEsito(BigInteger idNotificaEsito) {
        this.idNotificaEsito = idNotificaEsito;
    }
